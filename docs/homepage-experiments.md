...
**Upcoming score windows:** EXP-012 → 2026-07-28 · EXP-015 → 2026-07-29 · EXP-010 → 2026-07-31 (extended) · EXP-016 → ship after EXP-010 concludes (2026-07-31) · EXP-017 → ship after EXP-012 scored (2026-07-28). **Recently concluded: EXP-014 inconclusive (2026-07-27 — low traffic volume on target pages, same pattern as EXP-007). EXP-001/002/003 inconclusive (2026-07-26 — no valid baseline). EXP-005 inconclusive, EXP-011 win +12.3% (2026-07-25). EXP-004/009 no_effect (2026-07-24).**
