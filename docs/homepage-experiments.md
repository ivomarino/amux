...
**Upcoming score windows:** EXP-018 → 2026-08-06 · EXP-016 → 2026-08-08 · EXP-019 → 2026-08-09 · EXP-020 → 2026-08-10 · EXP-021 → 2026-08-11. **Recently concluded: EXP-017 inconclusive 2026-08-04 (best-multiplexers callout on compare index; 2 named clicks, same low-traffic pattern as EXP-012). EXP-016 shipped 2026-08-01 (CTO/team persona framing; measure after 2026-08-08). EXP-010 WIN +20.0% (2026-07-31 — phone-first row reorder kept permanently). EXP-015 WIN +200% (2026-07-29 — top-of-page CTA on headless kept permanently). EXP-012 inconclusive (2026-07-28). EXP-014 inconclusive (2026-07-27).**
...
### EXP-022 — Top-of-page green CTA on harness-engineering (138 PVs, buried CTA only)
- **Hypothesis:** /guides/harness-engineering/ is the 6th-highest-traffic page on the site (138 PVs/14d) but has only the buried EXP-014 indigo CTA — the same setup as claude-code-headless before EXP-015 (+200%). Applying the top-of-page green banner pattern before the intro paragraph will convert significantly better than the buried block.
- **Page:** `/guides/harness-engineering/`
- **KPI:** GitHub stars (PostHog `exp022_harness_topofpage_cta_click` + autocapture)
- **Status:** `queued`
- **Effort:** XS
- **Measure after:** 7 days from ship date
...
- **Status:** `running`
- **Started:** 2026-08-04
- **Implementation:** Added green/teal top-of-page CTA banner immediately after `<article>` open and before first paragraph. Copy: "Engineering context for a fleet of Claude Code, Codex, and Gemini CLI sessions? amux makes every surface — CLAUDE.md, hooks, skills, memory — available to every agent automatically." Button: "View amux on GitHub ★" with `exp021_context_eng_topofpage_cta_click` event. dateModified updated to 2026-08-04. Same compact banner format as EXP-015 WIN and EXP-020.
- **Effort:** XS
...
- **Status:** `running`
- **Started:** 2026-08-03
- **Implementation:** Added green/teal CTA banner after subtitle paragraph and before TL;DR block. Copy: "Running Claude Code, Gemini CLI, and Codex in parallel? amux orchestrates a fleet of terminal agents with self-healing, a shared kanban board, and a web + mobile dashboard." Button: "View amux on GitHub ★" with `exp020_blog_topofpage_cta_click` event. dateModified updated to 2026-08-03. Same compact banner format as EXP-015 WIN.
- **Effort:** XS
- **Measure after:** 2026-08-10 (7 days minimum)
