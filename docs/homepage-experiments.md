...
- **Score (2026-08-28):** Inconclusive — no PostHog API access to confirm named events. Page had 4 GH clicks/14d prior (genuine human traffic, not bot-dominated). Strongest candidate for re-score when PostHog access restored. CTA kept.
...
- **Effort:** M (new page)
- **Score (2026-08-28):** Inconclusive — new page, 7 days old. Same bot-traffic pattern as EXP-024/035/036/037/050 at 7 days. No PostHog access to confirm named events. CTA kept. Re-score 2026-09-11 (21-day window).
- **Measure after:** 2026-08-28 (7 days minimum)

### EXP-066 — Top-of-page green CTA on /compare/amux-vs-plandex/ (enriched August 2026)
- **Hypothesis:** amux-vs-plandex/ was last updated July 8 (51 days stale) with outdated "Python 3 and tmux" install references and no green top-of-page CTA. Enriching it with August 2026 features (session cloning, ISOLATED mode, amux-remote) and adding the EXP-066 CTA banner follows the EXP-064 pattern (cline compare, same treatment, measure 2026-09-03).
- **Page:** `/compare/amux-vs-plandex/`
- **KPI:** GitHub stars (`exp066_plandex_compare_topofpage_cta_click`)
- **Status:** `running`
- **Started:** 2026-08-28
- **Implementation:** dateModified → 2026-08-28, "Python 3 and tmux" → "single Rust binary" in FAQ and CTA, 3 new comparison table rows (session cloning, ISOLATED workers, remote management), "What's New in amux — August 2026" section (4 bullets), updated FAQ JSON-LD with remote management Q, top-of-page green CTA baked in.
- **Effort:** S (page enrichment + CTA)
- **Measure after:** 2026-09-04 (7 days minimum)

### EXP-067 — Top-of-page green CTA baked into new /guides/run-ai-agents-remotely/
- **Hypothesis:** "run AI agents remotely", "amux remote server", and "connect to remote amux" are uncovered high-intent queries with zero dedicated coverage on the site. The amux-remote feature (b9f4f65a) ships SSH/Tailscale-based remote CLI-to-server connection — a primary differentiator for teams with remote devboxes. New guide with CTA baked in at launch follows EXP-050/061/063 pattern.
- **Page:** `/guides/run-ai-agents-remotely/` (new page)
- **KPI:** GitHub stars (`exp067_remote_guide_topofpage_cta_click`)
- **Status:** `running`
- **Started:** 2026-08-28
- **Implementation:** Full new guide — HowTo 5-step schema (install remote, auth token, find IP, configure local, verify), FAQPage 6 Qs, Article + BreadcrumbList JSON-LD, fleet topology table, server sizing guide (4 rows), overnight remote workflow section, security considerations. datePublished/dateModified 2026-08-28.
- **Effort:** M (new page)
- **Measure after:** 2026-09-04 (7 days minimum; extend to 2026-09-18 if bot-traffic pattern)

### EXP-069 — Top-of-page CTA baked into new /guides/ai-agent-server-sizing/
- **Hypothesis:** No existing page covers AI agent server hardware requirements — a common pre-purchase question for developers evaluating whether to run amux on an existing machine or provision a new VM. Targeting "how much RAM for AI coding agents", "AI agent server requirements 2026", "server spec for Claude Code". New commit 679f93a1 (OOM protection) provides a concrete amux differentiator to feature.
- **Page:** `/guides/ai-agent-server-sizing/` (new page)
- **KPI:** GitHub stars (PostHog `exp069_server_sizing_guide_cta_click` + autocapture)
- **Status:** `running`
- **Started:** 2026-08-29
- **Implementation:** Full new guide — RAM requirements table by fleet size (1-5 to 50+ agents), cloud VM recommendation table with prices (Hetzner CX22 through AWS r6a.2xlarge), amux OOM protection section (commit 679f93a1), disk requirements section, remote management via amux-remote. HowTo JSON-LD (5 steps) + FAQPage JSON-LD (6 Qs) + Article + BreadcrumbList. EXP-069 CTA baked in at creation. datePublished/dateModified: 2026-08-29.
- **Effort:** M (new page)
- **Measure after:** 2026-09-05 (7 days minimum; extend to 2026-09-19 if bot-traffic pattern)

### EXP-068 — Top-of-page green CTA on /compare/amux-vs-zed/ (51 days stale, enriched August 2026)
- **Hypothesis:** amux-vs-zed/ is 51 days stale (last updated July 9). Zed has a growing AI user base — millions of users. Enriching with August 2026 features (session cloning, ISOLATED workers, amux-remote) and adding the green CTA banner should lift GitHub clicks on a page that targets the "Zed vs amux" query space where both audiences are heavy terminal/AI users.
- **Page:** `/compare/amux-vs-zed/`
- **KPI:** GitHub stars (PostHog `exp068_zed_compare_topofpage_cta_click` + autocapture)
- **Status:** `running`
- **Started:** 2026-08-29
- **Implementation:** dateModified 2026-07-09→2026-08-29, subtitle "Updated July 2026"→"Updated August 2026", green top-of-page CTA added (374+ stars, multi-runtime framing), 3 new comparison table rows (session cloning, ISOLATED workers, amux-remote), "What's New in amux — August 2026" section (4 bullets), new FAQ Q/A in JSON-LD and HTML about remote management. `exp068_zed_compare_topofpage_cta_click` event.
- **Effort:** S (page enrichment + CTA)
- **Measure after:** 2026-09-05 (7 days minimum)
...
- **Score (2026-08-29):** Inconclusive — no PostHog API access to confirm named events. This page had 9 GH clicks/14d prior — the best-converting compare page we had ever targeted, making it a genuine candidate, not a bot-traffic page. CTA kept. First to re-score when PostHog access restored.
...
- **Measure after:** 2026-08-29 (7 days minimum)
- **Score (2026-08-29):** Inconclusive — no PostHog API access to confirm named events. /for/ctos/ does not have prior GH click history on record, so bot-traffic pattern cannot be ruled out. CTA kept. Re-score when PostHog access restored.
...
| EXP-051 — /glossary/agent-multiplexer/ top-of-page green CTA (4 GH clicks/14d) | 2026-08-21 | 2026-08-28 | Inconclusive — no PostHog access. Page had demonstrated human traffic (4 GH clicks/14d prior). Genuine candidate — re-score when PostHog restored. CTA kept. | inconclusive |
| EXP-052 — /glossary/ai-agent-control-plane/ top-of-page CTA (new page) | 2026-08-21 | 2026-08-28 | New page, 7 days old. Same bot-traffic pattern as EXP-024/035/036/037/050. CTA kept. Re-score 2026-09-11 (21 days). | inconclusive |
...
| EXP-053 — /for/ctos/ top-of-page green CTA (high-intent persona page) | 2026-08-22 | 2026-08-29 | No PostHog access. No prior GH click history on record — bot-traffic pattern possible. CTA kept. Re-score when PostHog restored. | inconclusive |
| EXP-054 — /compare/amux-vs-cmux/ top-of-page green CTA (9 GH clicks/14d) | 2026-08-22 | 2026-08-29 | No PostHog access. Page had 9 GH clicks/14d prior — best-converting compare page ever targeted. Genuine candidate. First to re-score when PostHog restored. CTA kept. | inconclusive |
| EXP-066 — /compare/amux-vs-plandex/ top-of-page green CTA (enriched Aug 2026) | 2026-08-28 | 2026-09-04 (running) | — | running |
| EXP-067 — /guides/run-ai-agents-remotely/ top-of-page CTA (new page) | 2026-08-28 | 2026-09-04 (running) | — | running |
| EXP-068 — /compare/amux-vs-zed/ top-of-page green CTA (51 days stale, enriched Aug 2026) | 2026-08-29 | 2026-09-05 (running) | — | running |
| EXP-069 — /guides/ai-agent-server-sizing/ top-of-page CTA (new page) | 2026-08-29 | 2026-09-05 (running) | — | running |
...
| 2026-08-29 | GitHub stars: **374** (+1 since last run). **EXP-053 CONCLUDED inconclusive**: /for/ctos/ top-of-page CTA (started 2026-08-22, 7 days). No PostHog API access. No prior GH click history — bot-traffic pattern possible. CTA kept. **EXP-054 CONCLUDED inconclusive**: /compare/amux-vs-cmux/ top-of-page CTA (started 2026-08-22, 7 days). No PostHog API access. Page had 9 GH clicks/14d prior — best-converting compare page ever targeted, genuinely inconclusive rather than bot-traffic. CTA kept. First to re-score when PostHog restored. **EXP-068 SHIPPED**: /compare/amux-vs-zed/ enrichment + top-of-page green CTA. 51 days stale (July 9). Updated dateModified/subtitle to August 2026, 3 new feature table rows (session cloning, ISOLATED workers, amux-remote), "What's New August 2026" section, new FAQ Q on remote management, 374+ stars. `exp068_zed_compare_topofpage_cta_click`. Measure 2026-09-05. **EXP-069 SHIPPED**: baked into new /guides/ai-agent-server-sizing/. Targets "how much RAM for AI coding agents", "AI agent server requirements 2026", "server spec for Claude Code". RAM table (5 fleet sizes), cloud VM recommendations (6 VMs with prices), OOM protection section (commit 679f93a1), disk requirements, amux-remote link. HowTo (5 steps) + FAQPage (6 Qs) + Article + BreadcrumbList. `exp069_server_sizing_guide_cta_click`. Measure 2026-09-05 (extend to 2026-09-19 if bot-traffic). **J6**: changelog/notes.json 3 new entries (679f93a1 OOM protection, d3851425 dashboard fix, 7082b54c peek fix); changelog/index.html ItemList updated. **J7**: Lists fresh until 2026-09-09. Skipped. **J8**: Stars 374 vs "345+" = 8.3% off. Below 20% threshold. Skipped. sitemap.xml + llms.txt updated. AEO_BACKLOG.md appended. | **EXP-053/054** marked concluded inconclusive. **EXP-068** shipped (zed compare enrichment + CTA). **EXP-069** shipped (new ai-agent-server-sizing guide + CTA). changelog/notes.json 3 new entries + index.html ItemList updated. sitemap.xml + llms.txt updated. AEO_BACKLOG.md appended. |
| 2026-08-28 | GitHub stars: **373** (+6 since last run). **EXP-051 CONCLUDED inconclusive**: /glossary/agent-multiplexer/ top-of-page CTA (started 2026-08-21, 7 days). No PostHog API access to confirm named events. Page had 4 GH clicks/14d prior — genuine human traffic, unlike most inconclusive pages. Strongest candidate for re-score when PostHog access restored. CTA kept. **EXP-052 CONCLUDED inconclusive**: /glossary/ai-agent-control-plane/ new page (started 2026-08-21, 7 days). Same new-page bot-traffic pattern as EXP-024/035/036/037/050 at 7 days. CTA kept. Re-score 2026-09-11 (21-day window). **EXP-066 SHIPPED**: /compare/amux-vs-plandex/ enrichment + top-of-page green CTA. Most stale compare page (51 days). "Python 3 and tmux" → "single Rust binary" (FAQ + CTA), 3 new table rows (session cloning, ISOLATED workers, remote management), "What's New August 2026" section (4 bullets), dateModified 2026-08-28. `exp066_plandex_compare_topofpage_cta_click`. Measure 2026-09-04. **EXP-067 SHIPPED**: baked into new /guides/run-ai-agents-remotely/. Targets "run AI agents remotely", "amux remote server", "connect to remote amux" — zero prior coverage, primary amux-remote differentiator. HowTo (5 steps) + FAQPage (6 Qs) + Article + BreadcrumbList + fleet topology table + server sizing guide. `exp067_remote_guide_topofpage_cta_click`. Measure 2026-09-04 (extend to 2026-09-18 if bot-traffic pattern). **J6**: changelog/notes.json 3 new entries (33e4d206 ISOLATED option, 064d6ebe amux-worker, 7add17ec Claude model fix); changelog/index.html ItemList updated (33e4d206, 064d6ebe, 7add17ec, 0ae647b1, 7f197c13). **J7**: Lists fresh until 2026-09-09. Skipped. **J8**: Stars 373 vs "345+" = 8.1% off. Below 20% threshold. Skipped. sitemap.xml + llms.txt updated. AEO_BACKLOG.md appended. | **EXP-051/052** marked concluded inconclusive. **EXP-066** shipped (plandex enrichment + CTA). **EXP-067** shipped (new run-ai-agents-remotely guide, CTA baked in). changelog/notes.json 3 new entries + index.html ItemList updated. sitemap.xml + llms.txt updated. AEO_BACKLOG.md appended. |
