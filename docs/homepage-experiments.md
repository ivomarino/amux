...
**Upcoming score windows:** EXP-016 → ship now (EXP-010 concluded) · EXP-017 → 2026-08-04 · EXP-018 → 2026-08-06. **Recently concluded: EXP-010 WIN +20.0% (2026-07-31 — phone-first row reorder: 3.6→4.3 iOS clicks/day over 14d post window, kept permanently). EXP-015 WIN +200% (2026-07-29 — top-of-page CTA on headless: 0.29→0.86 GH clicks/day, 5 named events). EXP-012 inconclusive (2026-07-28). EXP-014 inconclusive (2026-07-27). EXP-001/002/003 inconclusive (2026-07-26). EXP-005 inconclusive, EXP-011 win +12.3% (2026-07-25). EXP-004/009 no_effect (2026-07-24).**
